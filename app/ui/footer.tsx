...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer
        id="footer"
        className="bottom-0 left-0 w-full h-96 bg-slate-900 p-5 md:p-20"
      >
        <div className="flex flex-row justify-between h-full">
          <div className="flex flex-col justify-between">
            <div className="px-5 md:px-20 md:text-2xl text-xl uppercase font-bold">
              <svg
            ...
            <div className="px-5 md:px-20 md:text-lg text-sm uppercase font-bold flex flex-row gap-2 items-center">
              <FaCopyright></FaCopyright> Copyright
            </div>
          </div>
          <div className="flex flex-col justify-center gap-5">
            <div className="px-5 md:px-20">
              <h1 className="md:text-xl text-lg uppercase font-bold">
                Mød Mig Her
              </h1>
              <p>
          ...
          <div className="flex flex-col justify-end gap-5 md:px-20 px-5 text-4xl">
            <ArrowUpIcon
