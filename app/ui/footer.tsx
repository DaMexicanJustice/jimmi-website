      ...
      <footer id="footer" className="bottom-0 left-0 text-white">
        ...
        <div className="flex flex-col md:hidden gap-10 py-10 items-center">
          ...
          <div className="flex flex-col gap-5 text-center">
            <div className="">
              <h1 className="m-0 text-5xl uppercase font-bold">Mød Mig Her</h1>
            ...
            <div className="">
              <h1 className="m-0 text-5xl uppercase font-bold">
                Skriv Til Mig
              </h1>
              <p className="m-0 text-3xl">jl@mentorplan.dk</p>
            </div>
            <div className="">
              <h1 className="m-0 text-5xl uppercase font-bold">Ring På</h1>
              <p className="m-0 text-3xl">+4542955969</p>
            </div>
          </div>
        ...
        <div className="hidden md:flex flex-row justify-between w-svh px-20 py-5">
          <div className="flex flex-col p">
            <div className="text-3xl text-sm uppercase font-bold">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="299.87"
                height="97.83"
                viewBox="0 0 299.87 97.83"
                className="fill-current dark:text-white-500 w-32"
              >
                <defs>
                  <style>.cls-1{}</style>
                </defs>
            ...
            <div className="text-xs uppercase font-bold flex flex-row justify-center items-center gap-1">
              <FaCopyright></FaCopyright> Copyright
            </div>
          </div>
