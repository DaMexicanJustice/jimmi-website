  ...
  return (
    <>
      <section id="Hero" className="px-5 md:px-20 h-[calc(100svh-6rem)] mt-24">
        <main className="flex flex-col items-center justify-center h-full gap-5 md:px-20 z-40 relative font-conduit">
          <div className="flex flex-row items-center gap-3">
            <hr className="md:w-28 w-20"></hr>
            <h3 className="text-3xl md:text-5xl font-bold text-white">
              Mentorplan
            </h3>
            <hr className="md:w-28 w-20"></hr>
          </div>
          <h1 className="text-3xl md:text-6xl whitespace-pre font-bold uppercase text-white">
            Dit fulde &nbsp;
