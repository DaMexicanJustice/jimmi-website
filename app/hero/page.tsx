...
export default function Hero() {
  return (
    <>
      <section id="Hero" className="px-5 md:px-20 h-[calc(100svh-6rem)] mt-24">
        <main className="flex flex-col items-center justify-center h-full gap-5 md:px-20 z-40 relative">
          <div className="flex flex-row items-center gap-3">
            <hr className="md:w-28 w-16"></hr>
            <h3 className="text-sm font-bold">Mentorplan</h3>
            <hr className="md:w-28 w-16"></hr>
          </div>
          <h1 className="text-3xl whitespace-pre font-bold uppercase">
            Dit fulde &nbsp;
          ...
          <h2 className="text-sm font-semibold">
            Gennem personlig mentoring & støttetjenester
          </h2>
          <h2 className="text-sm font-semibold">
